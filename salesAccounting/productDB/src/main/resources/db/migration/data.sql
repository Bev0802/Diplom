...
-- Создаем таблицу document_items
...
-- Вставляем демонстрационные данные в таблицу product (продолжение)
...
-- Вставляем демонстрационные данные в таблицу orders (продолжение)
...
-- Вставляем демонстрационные данные в таблицу order_items (продолжение)
INSERT INTO order_items (order_id, product_id,  quantity, price, amount) VALUES
                                                                             ...
                                                                             (5, 12, 5, 400, 2000), -- Добавляем товар "батончик Марс" в заказ "ORD_5_1_2/1"
                                                                             (5, 11, 5, 600, 3000); -- Добавляем товар "конфета Маска" в заказ "ORD_5_1_2/1"

-- Вставляем демонстрационные данные в таблицу documents (продолжение)

-- Вставляем демонстрационные данные в таблицу document_items (продолжение)
